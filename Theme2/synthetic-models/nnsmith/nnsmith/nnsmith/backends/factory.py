...
from nnsmith.nnsmith.difftest import assert_allclose
from nnsmith.nnsmith.error import InternalError
from nnsmith.nnsmith.logging import CORE_LOG
from nnsmith.nnsmith.materialize import BugReport, Model, Oracle, Stage, Symptom, TestCase
...
class BackendFactory(ABC):
    ...
    def critical_assert_dispatchable(self, model: Model):
        if not self.make_backend.dispatch(type(model)):
            CORE_LOG.critical(
                ...
                "Check https://github.com/ise-uiuc/nnsmith.nnsmith#backend-model-support for compatile `model.type` and `backend.type`."
            )
            sys.exit(1)
    ...
    def init(name, target="cpu", optmax=True, **kwargs):
        ...
        if name == "onnxruntime":
            from nnsmith.nnsmith.backends.onnxruntime import ORTFactory
            ...
            from nnsmith.nnsmith.backends.tvm import TVMFactory
            ...
            from nnsmith.nnsmith.backends.tensorrt import TRTFactory
            ...
            from nnsmith.nnsmith.backends.tflite import TFLiteFactory
            ...
            from nnsmith.nnsmith.backends.xla import XLAFactory
            ...
            from nnsmith.nnsmith.backends.torchjit import TorchJITFactory
