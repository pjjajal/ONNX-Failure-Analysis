...
from nnsmith.nnsmith.abstract.arith import *
from nnsmith.nnsmith.abstract.dtype import *
from nnsmith.nnsmith.abstract.op import (
    AbsOpBase,
    AbsTensor,
    Expand,
    Placeholder,
...
from nnsmith.nnsmith.error import ConstraintError, SanityCheck
from nnsmith.nnsmith.gir import GraphIR, InstExpr, InstIR
from nnsmith.nnsmith.logging import MGEN_LOG, SMT_LOG
from nnsmith.nnsmith.util import HAS_PYGRAPHVIZ, set_seed, viz_dot
...
class BaseGen:
    ...
    def abstract_gen(self, max_node_size=10, max_gen_millisec=2000):
        ...
        # starts generation.
        while (
            time.time() - init_time < max_gen_millisec / 1000 and
            # or self.num_op() < max_node_size
